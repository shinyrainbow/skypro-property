            ...
            <div className="prose prose-lg max-w-none text-gray-600">
              ...
              <section className="mt-12 p-6 bg-gray-50 rounded-xl">
                ...
                <div className="space-y-2 text-gray-600">
                  <p><strong>{t("terms.contact.company")}:</strong> Sky Pro Property Co., Ltd.</p>
                  <p><strong>{t("terms.contact.email")}:</strong> contact@skyproperty.co.th</p>
                  <p><strong>{t("terms.contact.phone")}:</strong> 091-8599695</p>
                </div>
              </section>
